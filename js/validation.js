...
//scripting for client
	...
	$(function () {
		...
		e.preventDefault();
				...
				function brandThree($client_id = null)
				{
...
//for account setting screen
	...
	//for account settings		
		...
		/*	function validateEmail(email) {
 			...
 			if  (document.getElementById("changed_value").value == '') {
 				 document.getElementById("changed_value").style.borderColor = "red";
 				 document.getElementById("changed_value").focus();
				toastr.error('Please enter value');
 				 return false;
 		    }else if(!validateEmail(document.getElementById("changed_value").value)){
 		    	 document.getElementById("changed_value").style.borderColor = "red";
 				 document.getElementById("changed_value").focus();
				toastr.error('Please enter valid email');
 				 return false;
 			}else {
 		     document.getElementById("changed_value").style.borderColor = "";
 			}
 			
				var value=document.getElementById("changed_value").value;
		...
		/*	$(function () {
			...
			function addressone(e){
		        ...
		        return ((k > 64 && k < 91) || (k > 96 && k < 123) || k == 44||k == 35||k == 32|| k == 38||k == 46||k == 39|| (k >= 48 && k <= 57));
		        }
