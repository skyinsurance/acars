	 ...
	 <?php ActiveForm::end(); ?>	
        ...
        'columns' => [
			...
			'value' => function ($model, $key, $index, $widget) {
               ...
               return '<a class="pointer" onclick=openGridshadowlogin("'.$user_id.'");>'.$clientno.'</a>'  ;            
			//	return Html::a($clientno, ['/shadowlogin', 'id' =>$user_id], ['target'=>'_blank','onclick'=>'openGridshadowlogin('.$user_id.');']);
			},
			'headerOptions' => [ 
					'style' => 'background-color:#428bca' 
			],
