            ...
            <form class="form-horizontal" style="margin-left: 33px;">
              ...
              <div class="col-md-6">
                 ...
                 <select class="form-control form-height">
                     ...
                     <option selected>ACAReportingService.com</option>
                ...
                <div class="col-sm-12">
                  <label class="control-label"><h4>Client Number</h4></label>
                    <input type="text" value="1000" class="form-control form-height" id="inputEmail3" placeholder="" readonly disabled value="ACA-10000">
                  </div>
                </div>
                ...
                <div class="form-group">
                 <div class="col-sm-12">
                  <label class="control-label"><h4>Client Name<span class="imp_red">*</span></h4></label>
                     <input type="text" value="Bob Marley" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  <label class="control-label"><h4>Order Number</h4></label>
                    <input type="text" value="4000" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                   <div class="col-sm-12">
                  <label for="inputEmail3" class="control-label"><h4>Contact Person First Name<span class="imp_red">*</span></h4></label>
                     <input type="text" value="Bob" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Contact Person Last Name<span class="imp_red">*</span></h4></label>
                      <input type="text" value="marley" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                   <div class="col-sm-12">
                  <label for="inputEmail3" class="control-label"><h4>Contact Person Email<span class="imp_red">*</span></h4></label>
                     <input type="text" value="bob@gmail.com" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Contact Person Phone Number<span class="imp_red">*</span></h4></label>
                     <input type="text"value="9898989889" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Product</h4></label>
                     <select class="form-control form-height">
                     <option>Select</option>
                     <option selected>ACA B Forms Only</option>
                ...
                <div class="col-sm-12">
                  <label for="inputEmail3" class="control-label"><h4>Number of Forms Bought</h4></label>
                   <input type="text"value="100" class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text"value="22-65454"  class="form-control form-height" id="inputEmail3" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="control-label"><h4>Price Paid</h4></label>
                   <div class="input-group " style="margin-bottom: 10px;">
						<span class="input-group-addon">$ </span> <input type="text"  name="" value="12" class="form-control form-height" >
																			</div>
                   </div>
                </div>
