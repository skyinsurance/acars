...
.show-more{
	 ...
	 width: 50%;margin-top: 15px;    margin-bottom: 15px;padding-left:0px;
}
...
<!-- small box -->
  <div class="small-box sky-primary-blue" >
		...
		<h3 class="pull-right color-white-year">76</h3>
        ...
        <div class="small-box sky-medium-blue">
            ...
            <div class="inner padding-top-inner">
				<h3 class="pull-right color-white-year">643</h3>
				<div class="col-xs-12 padding-right-0  ">
        ...
        <div class="small-box sky-lite-blue">
              ...
              <i class="fa fa-calculator"></i>
        		  ...
        		  <div class="inner padding-top-inner">
					<h3 class="pull-right color-white-year">1589</h3>
					<div class="col-xs-12 padding-right-0 ">
	  ...
	  <div class="col-lg-4 col-xs-12 col-md-6">
        ...
        <div class="small-box sky-lite-blue">
              ...
              <i class="fa fa-calculator"></i>
        		  ...
        		  <div class="inner padding-top-inner">
					<h3 class="pull-right color-white-year">500</h3>
					<div class="col-xs-12 padding-right-0 ">
        ...
        <div class="small-box sky-medium-blue">
              ...
              <i class="fa fa-calculator"></i>
        		  ...
        		  <div class="inner padding-top-inner">
					<h3 class="pull-right color-white-year">5</h3>
					<div class="col-xs-12 padding-right-0 ">
