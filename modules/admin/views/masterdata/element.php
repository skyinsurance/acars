							...
							<div class="box-body table-responsive">
								<table id="exampleCompany" class="table table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											<td readonly style="width: 9%;">1.1</td>
											<td>Basic Information - Basic Reporting Info</td>
											<td style="width: 50%;" ><input type="text" class="form-control"  value="Employer Name (Legal Name for IRS Filing)"/></td>
									...
									<!-- 		<td style="text-align: center;"><a
										...
										<tr>
											<td readonly style="width: 9%;">1.2</td>
											<td>Basic Information - Basic Reporting Info</td>
											<td style="width: 50%;" ><input type="text" class="form-control" value="Employer Identification Number (EIN)"/></td>
									...
									<!-- 		<td style="text-align: center;"><a
										...
										<tr>
											<td readonly style="width: 9%;">1.3</td>
											<td>Basic Information - Basic Reporting Info</td>
											<td style="width: 50%;" ><input type="text" class="form-control"  value="Tax Reporting Year"/></td>
									...
									<!-- 		<td style="text-align: center;"><a
										...
										<tr>
											<td readonly style="width: 9%;">1.4</td>
											<td>Basic Information - Basic Reporting Info</td>
											<td style="width: 50%;" ><input type="text" class="form-control" value="Contact Person Legal First Name"/></td>
