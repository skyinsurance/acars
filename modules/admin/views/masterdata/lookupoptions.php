					...
					<table id="exampleLookupoptions" class="table table-bordered table-hover">
						...
						<?php  foreach($model as $options){?>	
							<tr>
								...
								<td><?php print_r($options->code->lookup_code);?></td>
								<td><?php echo $options->lookup_value;?></td>
							...
							<span style="color:red;">Inactive</span></a><?php }?></td>
								...
								<td><a class="OpenEditModel pointer" onclick="openlookupoptionEditmodal(<?php echo $options->lookup_id;?>);" title="edit" style="margin-left: 13px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
							 	<td><a title="delete" onclick="deletelookupModal(<?php echo $options->lookup_id;?>);" href="#" style="margin-left: 13px;color:red;"><i class="fa fa-times" aria-hidden="true"></i></a></td>
