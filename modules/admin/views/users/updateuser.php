			...
			<form class="form-horizontal" style="margin-left: 33px;">
				<div class="box-body">
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>First Name</h4></label> <input value="Praveen"
					...
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>Last Name</h4></label> <input value="Singh"
								type="text" class="form-control form-height" id="inputEmail3"
								placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>Email</h4></label> <input value="parveen@gmail.com"
								type="text" class="form-control form-height" id="inputEmail3"
								placeholder="">
						</div>
					</div>
