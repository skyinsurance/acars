...
<div class=" box box-warning container-fluid">
	...
	<div class="col-xs-12 header-new-main width-98 hide">
		...
		<p class="sub-header-new">You can add user from this screen.</p>
	</div>
	<div class="col-md-12">
		<div class=" box-info">
			...
			<form class="form-horizontal" style="margin-left: 33px;">
				<div class="box-body">
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>First Name</h4></label> <input
						...
						<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>Last Name</h4></label> <input
								type="text" class="form-control form-height" id="inputEmail3"
								placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							<label class="control-label"><h4>Email</h4></label> <input
								type="text" class="form-control form-height" id="inputEmail3"
								placeholder="">
						</div>
					</div>
