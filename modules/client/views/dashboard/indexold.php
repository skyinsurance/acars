...
<div class="box box-warning container-fluid">
	...
	<div class="box-header with-border padding-left-0 padding-right-0">
              <h3 class="box-title col-xs-6 padding-left-0">ABC Corp (Days  remaining to E-File : 74 days)</h3>
			  <div class="col-xs-6 pull-right padding-right-0">
			 <span class="col-xs-7 pull-right padding-right-0" style="font-size: 18px;text-align: right;"><b>Need help? Call 1-800-888-8888</b></span>
  ...
  <div class="small-box sky-primary-blue" >
        ...
        <div class="small-box sky-medium-blue">
            ...
            <div class="inner padding-top-inner">
				...
				<div class="col-xs-12 padding-right-0  ">
		          <p class="pull-right color-white">Total Numbers of Employees  </p>
		          </div>
	       	</div>
    ...
    <div class="col-md-5 col-sm-7 col-xs-12 details description" style="padding-left: 0;">
			<p><b>Your Personal Account Manager is</b></p>
			<hr class="hr-tag">
           <div class="col-xs-3" style="padding-top:15px;    padding-left: 0;">
			...
			<div class="col-xs-12">
					...
					<a href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/client/dashboard/reporting">	<button type="button" class="pull-left btn btn-success " style="width:46%; font-size: 17px;    margin-top: 8%;margin-bottom: 2%;">Get Started Now</button>
					</a>
					</div>	
	<!-- 	 <div class="col-xs-12">
