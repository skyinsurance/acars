...
$(document).ready(function(){
			    $('#exampleUpdatecompanyusers').DataTable({
...
<div class="box box-warning">
	...
	<div class="col-md-12">
              <h3 class="box-title col-xs-6">Update User - ABC Corp <small>(ACA-10000-1)</small></h3>
	...
	<div class="col-xs-12 header-new-main width-98 hide">
		...
		<p class="sub-header-new">User created can be Updated from below screen.</p>
	</div>
		...
		<div class="col-md-12">
			...
			<div class="col-sm-6">
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" value="Bob" class="form-control form-height"
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" value="Marley" class="form-control form-height"
							id="inputEmail3" placeholder="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" value="bob@gmail.com" class="form-control form-height"
							id="inputEmail3" placeholder="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text"  value="9898989898" class="form-control form-height"
							id="inputEmail3" placeholder="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control form-height" value="Accounts"
							id="inputEmail3" placeholder="">
			...
			<div class="col-sm-6">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control form-height" value="32/2rt"
							id="inputEmail3" placeholder="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control form-height" value="Hyderabad"
							id="inputEmail3" placeholder="">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control form-height" value="500082"
							id="inputEmail3" placeholder="">
			...
			<div class="">
				...
				<div class="col-xs-12 panel-0">
					...
					<table id="exampleUpdatecompanyusers" class="table table-bordered table-hover">
					<thead>
			...
			<div class="col-sm-12">
			 <div class="box-footer pull-right" >
			 		<a class="btn btn-success " href="<?php echo Yii::$app->homeUrl;?>client/dashboard/users">Update</a>
