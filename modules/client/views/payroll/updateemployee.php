...
<div class=" box box-warning container-fluid">
	...
	<div class="box-header with-border">
		<h3 class="box-title col-xs-6">Update Employee Record - ABC Corp <small>(ACA-10000-1)</h3>
			...
			<form class="">
				...
				<div class="box-body">
					<div class="row" style="margin-bottom: 20px;">
							...
							<div class="form-group col-sm-6">
								<div class="">
									...
									<input type="text" class="form-control form-height"
										id="inputEmail3" placeholder="" value="Bob">
								</div>
							</div>
                     ...
                     <option <?php if($key == 'SC') {?> selected
											<?php }?>>( <?php echo $key;?> ) <?php echo $value; ?> </option>
                     <?php } ?>
                     </select>
								</div>
							</div>
								...
								<div class="">
									<div class="">
										<label style="margin-top: 15px;"><input type="checkbox"
											checked value="" id="flag_checkbox"><span
											class="control-label flag_checkbox">Flag this person</span></label>
										<input type="text" class="form-control form-height"
											id="flag_textarea" placeholder=""
											value="Employee Discussion Needed">
							...
							<div class="box-body table-responsive">
								...
								<table id="employment_period_div"
									...
									<tbody>
										...
										<tr>
											<td><input type="text" class="datepicker form-control" value="2014-01-01"></td>
											<td><input type="text" class="datepicker form-control" value="2016-01-01"></td>
											<td><select class="form-control"><option value="1">Option1</option>
													<option value="2" selected>Option2</option></select></td>
											<td><select class="form-control"><option value="1">FT</option>
													<option value="2" selected>PT</option></select></td>
											<td><input type="checkbox" name="chkbox[]" checked></td>
											<td><textarea name="">Completed</textarea></td>
											<td><a onclick="deleteRow(1)" data-toggle="tooltip"
												data-placement="bottom"
												data-original-title="Delete this row"
												style="margin-left: 13px; color: red; cursor: pointer;"><i
					...
					<div class=" row">
						...
						<a class="btn btn-default "
							...
							<a class="btn btn-success " href="<?php echo Yii::$app->homeUrl;?>client/payroll">Update and Exit</a>
