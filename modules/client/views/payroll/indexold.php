			...
			<div class="" id="heading-navbar-collapse">
				...
				<div class="navbar-right document-context-menu" style="margin-right: 0px !important;">
					...
					<div class="buttons pull-right" style="line-height: 35px;">
						<a type="reset" class="btn btn-success btn-sm filter-btn-search"
							style="" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/client/payroll/addemployee"> <i
...
-->
		...
		<div class=" col-md-12" style="margin-top: 15px;">
			<div class="payroll-div col-md-12 ">
				<div class="  col-md-12 padding-left-0 padding-right-0" >
					<div class="dealOffer col-md-10 col-xs-12  padding-left-0 padding-right-0"
						style="font-weight: 600;">


						<div class="" style="margin: 0px;">
							<label><input type="checkbox" value=""
								style="margin-right: 10px;"> <b style="margin-right: 10px;">Mr Bob Rich</b> <a
								style="color: #f3754d; margin-right: 10px;"
								class="fa  fa-flag fa-lg" href="#" data-toggle="tooltip"
								data-placement="bottom" title=""
								data-original-title="Employee discussion needed"></a></label>
						</div>
					</div>
					<span class=" col-md-2 col-xs-12 pull-right padding-left-0 padding-right-0" > <a
					 class="pull-right " 
					 href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/client/payroll/updateemployee"> View Details & Update </a>
				</span>
				</div>
				...
				<div class="col-md-12 padding-left-0 padding-right-0">
					<div class="col-xs-12 ">
						...
						<div class="col-xs-12">
						1342 Roper Mtn Rd., Suite 101, Green Ville, SC, 29555
						</div>
						</div>
						
						<div class="col-md-3 padding-left-0 padding-right-0">
						<label class=" col-sm-12 ">Social:&nbsp;&nbsp;<span style="font-weight: normal;">11-11-5555</span></label>
						</div>
						
						<div class="col-md-3 padding-left-0 padding-right-0">
						<label class=" col-sm-12 ">DOB:&nbsp;&nbsp;<span style="font-weight: normal;">1/1/55</span></label>
						</div>
			...
			<div class="payroll-div col-md-12 ">
				<div class="  col-md-12 padding-left-0 padding-right-0" >
					<div class="dealOffer col-md-10 col-xs-12  padding-left-0 padding-right-0"
						...
						<div class="" style="margin: 0px;">
							<label><input type="checkbox" value=""
								style="margin-right: 10px;"> <b style="margin-right: 10px;">Mr Bob Rich</b></label>
						</div>
					</div>
					<span class=" col-md-2 col-xs-12 pull-right padding-left-0 padding-right-0" > <a
					 class="pull-right " 
