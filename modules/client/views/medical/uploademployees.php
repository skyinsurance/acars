    ...
    <div id="ajax_alerts"></div>
      ...
      <div class="portlet box blue-hoki" style="    border: 1px solid #428bca">
        ...
        <div class="portlet-body form">
          ...
          <!-- BEGIN FORM-->
         <?php $form = ActiveForm::begin(['id' => 'import-contact-form','enableClientValidation' => true,'enableAjaxValidation' => true]); ?>
		 <div class="form-actions">
            <div class="form-body  compulsary-background" style="padding: 30px;">
              <div class="form-group" style="float: left;width: 100%;">
                ...
                <div class="col-md-6">
					...
					<?= $form->field($model_import, 'employee_id')
								->label(false)	
								->fileInput(['accept'=>'image/jpeg','id'=>'csv_file','class'=>'filestyle','data-buttonNam'=>'btn-primary']); ?>
              ...
              <div class="row">
				...
				<button type="button" class="btn default" onclick="location.href='<?php echo Yii::$app->getUrlManager()->getBaseUrl();  ?>/client/medical?c_id=<?php echo $_GET['c_id']; ?>'">Cancel</button>
