...
<script type="text/javascript" src="<?php  echo Yii::$app->homeUrl;?>js/dxgrid/dx.viz-web.js"></script> 
...
<script type="text/javascript" src="<?php  echo Yii::$app->homeUrl;?>js/client/medical.js"></script>
...
<div class="box box-warning container-fluid">
	...
	<div class="box-header with-border">
		<h3 class="box-title col-xs-6">Medical Plan Enrollment Data - <?php if(!empty($company_detals['company_name'])){echo htmlentities($company_detals['company_name']); }?> <small><?php if(!empty($company_detals['company_client_number'])){echo '('.htmlentities($company_detals['company_client_number']).')'; }?></small></h3>
			...
			<div class="" id="heading-navbar-collapse">
				...
				<div class="btn-group">
				  <a href="<?php echo Yii::$app->homeUrl;?>files/csv/sample.csv" class="btn btn-default"><i
								class="fa fa-download fa-lg btn_icons pd-r-5"></i>Download Medical Template</a>
				...
				<div class="btn-group">
				  <a href="<?php echo Yii::$app->homeUrl;?>client/medical/uploademployees?c_id=<?php echo $encoded_company_id; ?>" class="btn btn-default"><i
								class="fa fa-upload fa-lg btn_icons pd-r-5"></i>Upload Medical Data</a>
				  <!-- <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<span class="caret"></span>
					<span class="sr-only">Toggle Dropdown</span>
				  </button>
