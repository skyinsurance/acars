...
<div class="box box-warning container-fluid">
	<div class="box-header with-border">
		<h3 class="box-title col-xs-8">
			Basic Reporting Information - <?php echo $company_details->company_name; ?> <small> (<?php echo $company_details->company_client_number; ?>) </small>
		</h3>
							...
							<div class="panel  box " id="basicinformation">
								...
								<div id="collapseOne"
									...
									<div class="box-body">
										...
										<?php $form = ActiveForm::begin(['action' => ['/client/reporting/savebasicinfo?c_id='.$company_id.'#basicinformation'],'enableClientValidation' => false,'options' => ['enctype'=>'multipart/form-data','validateOnSubmit' => true,'class'=>'form-horizontal','id'=>'basic_info_form']]); ?>
															...
															<div class="box-body">
																<div class="col-xs-offset-1 col-xs-10">
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.1'])){ echo $arrsection_elements['1.1']; } ?></h4></label> 
																			<span class="form-control form-height"><?php echo $company_details->company_name; ?></span>
																		</div>

																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.2'])){ echo $arrsection_elements['1.2']; } ?></h4></label>
																			<span class="form-control form-height"><?php echo $company_details->company_ein; ?></span>
																		</div>
																	</div>

																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.3&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.3'])){ echo $arrsection_elements['1.3']; } ?></h4></label> 
																			<span class="form-control form-height"><?php echo $company_details->tbl_aca_company_reporting_period->year->lookup_value; ?></span>
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.4&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.4'])){ echo $arrsection_elements['1.4']; } ?></h4></label> 
																			<?=$form->field ( $model_basic_info, 'contact_first_name' )->textInput ( [ 'class' => 'form-control form-height','maxlength'=>'20','onkeypress'=>'return alpha(event);' ] )->label ( false )?>
    		
																				
																		</div>

																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.5&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.5'])){ echo $arrsection_elements['1.5']; } ?></h4></label> 
																			
																			<?=$form->field ( $model_basic_info, 'contact_middle_name' )->textInput ( [ 'class' => 'form-control form-height','maxlength'=>'20','onkeypress'=>'return alpha(event);' ] )->label ( false )?>
																		</div>
																	</div>

																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.6&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.6'])){ echo $arrsection_elements['1.6']; } ?></h4></label> 
																			<?=$form->field ( $model_basic_info, 'contact_last_name' )->textInput ( [ 'class' => 'form-control form-height','maxlength'=>'20','onkeypress'=>'return alpha(event);' ] )->label ( false )?>
																		</div>

																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.7&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.7'])){ echo $arrsection_elements['1.7']; } ?></h4></label> 
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.8&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.1'])){ echo $arrsection_elements['1.8']; } ?></h4></label> 
																					<?=$form->field ( $model_basic_info, 'contact_person_title' )->textInput ( [ 'class' => 'form-control form-height','maxlength'=>'34','onkeypress'=>'return alpha(event);' ] )->label ( false )?>
																	
																		</div>

																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.9&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.9'])){ echo $arrsection_elements['1.9']; } ?></h4></label> 
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.10&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.10'])){ echo $arrsection_elements['1.10']; } ?></h4></label> 
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.11&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.11'])){ echo $arrsection_elements['1.11']; } ?></h4></label>
																			<?=$form->field ( $model_basic_info, 'street_address_1' )->textInput ( [ 'class' => 'form-control form-height ','maxlength'=>'200' ] )->label ( false )?>
													
																		</div>

																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.12&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.12'])){ echo $arrsection_elements['1.12']; } ?></h4></label>
																			<?=$form->field ( $model_basic_info, 'street_address_2' )->textInput ( [ 'class' => 'form-control form-height ','maxlength'=>'200' ] )->label ( false )?>
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.13&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.13'])){ echo $arrsection_elements['1.13']; } ?></h4></label>
																			<?php 
																		...
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.14&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.14'])){ echo $arrsection_elements['1.14']; } ?></h4></label> 
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.15&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.15'])){ echo $arrsection_elements['1.15']; } ?></h4></label> 
																			<?php 
																		...
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.16&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.16'])){ echo $arrsection_elements['1.16']; } ?></h4></label> 
																			<?=$form->field ( $model_basic_info, 'contact_zip' )->textInput ( [ 'class' => 'form-control form-height numbers','maxlength'=>'5' ] )->label ( false )?>
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.17&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.17'])){ echo $arrsection_elements['1.17']; } ?></h4></label>
																		...
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.18&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.18'])){ echo $arrsection_elements['1.18']; } ?></h4></label> 
																	...
																	<div class="form-group">
																		<div class="col-sm-6">
																			<label class="control-label"><h4>1.19&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['1.19'])){ echo $arrsection_elements['1.19']; } ?></h4></label> 
							...
							<div id="collapseTwo"
								...
								<div class="box-body padding-right-0">
									...
									<div class="col-md-offset-1 col-md-10">
											...
											<div class="form-group">
												<div class="col-sm-6">
													<span class="control-label"><h4>2.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['2.1'])){ echo $arrsection_elements['2.1']; } ?></h4> <input
												...
												<div class="col-sm-6">
													<span class="control-label"><h4>2.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['2.2'])){ echo $arrsection_elements['2.2']; } ?></h4>
											...
											<div class="form-group">
												<div class="col-sm-12">
													<span class="control-label"><h4
															style="margin-bottom: 25px;">2.3&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['2.3'])){ echo $arrsection_elements['2.3']; } ?></h4>
								...
								<div class="box-body padding-right-0">
									...
									<div class="col-md-offset-1 col-md-10">
											...
											<div>
												...
												<div class="form-group">
													<div class="col-sm-12">
														<span class="control-label span-label"><h4>3.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.1'])){ echo $arrsection_elements['3.1']; } ?></h4> 
												...
												<div class="form-group initialmeasurement"
													...
													<div class="col-sm-12">
														<label class="control-label"><h4><?php echo $model_element_master->FindelementbyelementId('3.1.1')->element_id; ?>&nbsp;&nbsp;&nbsp;<?php echo $model_element_master->FindelementbyelementId('3.1.1')->element_label; ?></h4></label> 
												...
												<div class="form-group initialmeasurement"
													style="<?php if(isset($model_plan_offering_criteria->hours_tracking_method) && $model_plan_offering_criteria->hours_tracking_method == 1){
																				...
																				>
													<div class="col-sm-12">
														<label class="control-label"><h4><?php echo $model_element_master->FindelementbyelementId('3.1.2')->element_id; ?>&nbsp;&nbsp;&nbsp;<?php echo $model_element_master->FindelementbyelementId('3.1.2')->element_label; ?></h4> <input
											...
											<div class="col-sm-12 padding-left-0 padding-right-0">
												...
												<div class="form-group">
													<div class="col-sm-12">
														<label class="control-label"><h4>3.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.2'])){ echo $arrsection_elements['3.2']; } ?></h4></label>
														<?php 
												...
												<div class="form-group">
													<div class="col-sm-12">
														<label class="control-label"><h4>3.3&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.3'])){ echo $arrsection_elements['3.3']; } ?></h4>
														</label>

														<div class="col-sm-12">
															<label class="control-label"><h4>(a)&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.3.1'])){ echo $arrsection_elements['3.3.1']; } ?></h4> <input
														...
														<div class="col-sm-12">
															<label class="control-label"><h4>(b) &nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.3.2'])){ echo $arrsection_elements['3.3.2']; } ?></h4> <input
																 type="radio"
														...
														<div class="col-sm-12">
															<label class="control-label"><h4>(c) &nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['3.3.3'])){ echo $arrsection_elements['3.3.3']; } ?></h4> <input type="radio"
							...
							<div id="collapseFour"
								...
								<div class="box-body padding-right-0">
									...
									<div class="col-md-offset-1 col-md-10">
											...
											<div class="form-group">
												<div class="col-sm-12">
													<label class="control-label"><h4>4.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1'])){ echo $arrsection_elements['4.1']; } ?></h4> <input type="radio"
											...
											<div class="designation" style="<?php if(isset($model_designated_govt_entity->assign_dge) && $model_designated_govt_entity->assign_dge == 1){?> display: block;<?php }else{?>display: none;<?php }?>">
												...
												<div class="form-group">
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.1'])){ echo $arrsection_elements['4.1.1']; } ?></h4></label>
														
														<?=$form->field ( $model_designated_govt_entity, 'dge_name' )->textInput ( [ 'class' => 'form-control form-height dge-clear','maxlength'=>'20','onkeypress'=>'return alpha(event);' ] )->label ( false )?>
													</div>

													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.2'])){ echo $arrsection_elements['4.1.2']; } ?></h4></label> 
												...
												<div class="form-group">
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.3&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.3'])){ echo $arrsection_elements['4.1.3']; } ?></h4></label> 
														
														<?=$form->field ( $model_designated_govt_entity, 'street_address_1' )->textInput ( [ 'class' => 'form-control form-height dge-clear','maxlength'=>'200' ] )->label ( false )?>
													</div>

													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.4&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.4'])){ echo $arrsection_elements['4.1.4']; } ?></h4></label>
														
														<?=$form->field ( $model_designated_govt_entity, 'street_address_2' )->textInput ( [ 'class' => 'form-control form-height dge-clear','maxlength'=>'200' ] )->label ( false )?>
													</div>
												...
												<div class="form-group">
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.5&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.5'])){ echo $arrsection_elements['4.1.5']; } ?></h4></label> 
														
														<?=$form->field ( $model_designated_govt_entity, 'dge_city' )->textInput ( [ 'class' => 'form-control form-height dge-clear','maxlength'=>'20' ] )->label ( false )?>
													</div>
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.6&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.6'])){ echo $arrsection_elements['4.1.6']; } ?></h4></label> 
														
														<?php 
                  
															                   echo $form->field($model_designated_govt_entity, 'dge_state')->dropdownList(
															                  		$usStates,
															                  		['prompt'=>'Select State','class'=>'form-control form-height dge-clear']
															                  )->label(false);
															                  ?>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.7&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.7'])){ echo $arrsection_elements['4.1.7']; } ?></h4></label> 
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.8&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.8'])){ echo $arrsection_elements['4.1.8']; } ?></h4></label> 
													...
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.9&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.9'])){ echo $arrsection_elements['4.1.9']; } ?></h4></label> 
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.10&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.10'])){ echo $arrsection_elements['4.1.10']; } ?></h4></label> 
													...
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.11&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.11'])){ echo $arrsection_elements['4.1.11']; } ?></h4></label>
												...
												<div class="form-group">
													<div class="col-sm-6">
														<label class="control-label"><h4>4.1.12&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.12'])){ echo $arrsection_elements['4.1.12']; } ?></h4></label> 
												...
												<div class="form-group">
													<div class="col-sm-12 plan-div-margin"
														>
														<label class="control-label"><h4>4.1.13&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['4.1.13'])){ echo $arrsection_elements['4.1.13']; } ?></h4> <input type="radio"
								...
								<div class="box-body padding-right-0">
									...
									<div class="col-md-offset-1 col-md-10">
										<div class="form-group row"
											...
											<div class="col-sm-12">
												<label class="control-label"><h4>5.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.1'])){ echo $arrsection_elements['5.1']; } ?></h4> </label>
											</div>
											<div class="col-sm-6">
										...
										<div class="form-group row"
											style="margin-top: 10px; margin-bottom: 20px;">
											<div class="col-sm-12">
												<label class="control-label"><h4>5.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.2'])){ echo $arrsection_elements['5.2']; } ?></h4> </label>
											</div>
											<div class="col-sm-6">
										...
										<div class="col-xs-12 filling_forms" style="<?php if(isset($model_aggregated_group->is_ale_member) && $model_aggregated_group->is_ale_member == 1){
											...
											<div class="col-xs-12" style="border: 1px solid #ddd;">
												<div class="form-group row"
													style="margin-top: 10px; margin-bottom: 20px;">
													<div class="col-sm-12">
														<label class="control-label"><h4>5.2.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.2.1'])){ echo $arrsection_elements['5.2.1']; } ?></h4>
														</label>
													</div>
													<div class="col-sm-6">
												...
												<div class="form-group row other_entity_filling_yes"
													style="margin-top: 10px; margin-bottom: 20px; <?php if(isset($model_aggregated_group->is_other_entity) && $model_aggregated_group->is_other_entity == 1){
																					...
																					?> display: block;<?php }else {?> display: none;<?php }?>">
													<div class="col-sm-12">
														<label class="control-label"><h4>5.2.1.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.2.1.1'])){ echo $arrsection_elements['5.2.1.1']; } ?></h4> </label>
													</div>
												...
												<div class="form-group row"
													style="margin-top: 10px; margin-bottom: 20px;">
													<div class="col-sm-12">
														<label class="control-label"><h4>5.2.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.2.2'])){ echo $arrsection_elements['5.2.2']; } ?></h4> </label>
													</div>
												...
												<div class="form-group row"
													style="margin-top: 10px; margin-bottom: 20px;">
													<div class="col-sm-12">
														<label class="control-label"><h4>5.2.3&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['5.2.3'])){ echo $arrsection_elements['5.2.3']; } ?></h4> </label>
													</div>
															...
															<div class="col-sm-3 padding-right-0 padding_left_30">
																<p>Group Name</p>
															 	...
															 	<input type="text" class="form-control aggregate-clear" name="TblAcaAggregatedGroupList[<?php echo $i; ?>][group_name]" maxlength="34"
																	value="<?php if(!empty($list['group_name'])){ echo $list['group_name']; }?>" onkeypress="return alpha(event);" >
								...
								<div class="box-body padding-right-0">
									...
									<div class="col-md-offset-1 col-md-10">
										...
										<div class="form-group row"
											style="margin-top: 10px; margin-bottom: 20px;">
											<div class="col-sm-12">
												<label class="control-label"><h4>6.1&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['6.1'])){ echo $arrsection_elements['6.1']; } ?></h4> </label>
											</div>
											<?php 
										...
										<div class="form-group row"
											style="margin-top: 10px; margin-bottom: 20px;">
											<div class="col-sm-12">
												<label class="control-label"><h4>6.2&nbsp;&nbsp;&nbsp;<?php if(!empty($arrsection_elements['6.2'])){ echo $arrsection_elements['6.2']; } ?></h4> </label>
											</div>
											<div class="col-sm-6 padding_left_30">
