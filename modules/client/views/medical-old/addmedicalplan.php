...
<div class=" box box-warning container-fluid">
	...
	<div class="box-header with-border">
		<h3 class="box-title col-xs-6">Add Medical Plan Enrollment - ABC Corp <small>(ACA-10000-1)</h3>
				...
				<div class="box-body">
							...
							<div class="form-group col-sm-6">
								<div class="">
									<label for="inputEmail3" class="control-label"><h4>Date of
										...
										class="form-control datepicker form-height " id="inputEmail3"
										placeholder="">
					...
					<div class=" row">
						...
						<div class="box-footer pull-right">
							...
							<a class="btn btn-success " href="<?php echo Yii::$app->homeUrl;?>client/medical">Save and Exit</a>
