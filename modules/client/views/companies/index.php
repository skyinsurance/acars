...
<div class="box box-warning container-fluid">
	...
	<div class="box-header with-border">
		...
		<div class="col-xs-6 pull-right padding-right-0">
			<a class=" btn bg-orange btn-social pull-right " onclick="playVideo(1);"> <i
				...
				'filter' => false,
									'value' => function ($model, $key, $index, $widget) {
										...
										if (! empty ( $model->company_name )) {
											...
											return Html::a($company_name, ['/client/dashboard', 'c_id' =>$encrypt_id]);
										}
										else
										{
												return '<span style="">'.''.Html::tag('span', '<a><span class="fa fa-edit pointer marginr-6"></span></a>', ['class' => 'pointer','onclick'=>'showupdatemodal("'.$encrypt_id.'")']).''.'Update'.''.'</span>' ;
										}
											...
											'format' => 'raw'
												...
												'value' => function ($model, $key, $index, $widget) {
													...
													else
													{
														...
														return '<span style="">'.''.Html::tag('span', '<a><span class="fa fa-edit marginr-6 pointer"></span></a>', ['class' => 'pointer','onclick'=>'showupdatemodal("'.$encrypt_id.'")']).''.'Update'.''.'</span>' ;
...
'buttons' => [
    'my_button' => function ($url, $model, $key) {
       ...
       // return Html::a('<span class="fa fa-edit pointer"></span>', ['class' => 'pointer','onclick'=>'showupdatemodal('.$company_id.');']) ;
		return Html::tag('p', '<a><span class="fa fa-edit pointer marginr-6"></span></a>', ['class' => 'pointer','onclick'=>'showupdatemodal("'.$company_id.'")']) ;
},
]
			],
        ],
				...
				<div class="modal-dialog pswd-pop">
					<div class="modal-content">
						...
						<div class="modal-body float-left">
							...
							<div class="col-sm-8">
								<input class="form-control add-member-input" placeholder="" maxlength="34" onkeypress="return option(event);"
