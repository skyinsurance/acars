...
<div class="box box-warning container-fluid">
	<div class="box-header with-border">
              <h3 class="box-title col-sm-10">Basic Reporting Info</h3>
              <a class="col-sm-2 btn bg-orange btn-flat btn-social">
...
<span  style="display:none;" class="edit">Edit</span></span>
			...
			<div class="col-md-offset-1 col-md-10">  
                   ...
                   <div class="col-sm-12" >
                  <label class="control-label"><h4>Will this transmittal be the authoritative transmittal for your company? Remember, each EIN must have its own authorative transmittal </h4>
                    </label>
                  </div>
                  <div class="col-sm-6">
                  <input type="radio" name="aggregate_grps1"><span class="control-checkbox">&nbsp;&nbsp;&nbsp;&nbsp;Yes</span>&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <div class="form-group row" style="    margin-top: 10px;margin-bottom: 20px;">
                   <div class="col-sm-12" >
                  <label class="control-label"><h4>During any month of the year, were you a member of an aggregated applicable large employer (ALE) group ? This may also be referred to as control group. </h4>
                    </label>
                  </div>
                  <div class="col-sm-6">
                 ...
                 <input type="text" class="form-control form-height" id="inputEmail3" placeholder="">
                      ...
                      <div class="form-group row" style="    margin-top: 10px;margin-bottom: 20px;">
                   <div class="col-sm-12" >
                  <label class="control-label"><h4>How many months of the year were you a part of this aggreagted group?</h4>
                    </label>
                  </div>
                  <div class="col-sm-3">
                  
                  <div class="checkbox">
                 <label><input type="checkbox">Entire Year</label>
                  </div>
                  <div class="checkbox">
                 <label><input type="checkbox">January</label>
                  </div>
                  <div class="checkbox">
                 <label><input type="checkbox">February</label>
                  </div>
                  <div class="checkbox">
                 <label><input type="checkbox">March</label>
                  ...
                  <div class="col-sm-3">
                  <div class="checkbox">
                   <label><input type="checkbox">July</label>
                   </div>
                  <div class="checkbox">
                   <label><input type="checkbox">August</label>
                 </div>
                  <div class="checkbox">
                   <label><input type="checkbox">September</label>
                 </div>
                  <div class="checkbox">
                   <label><input type="checkbox">October</label>
                 </div>
                  <div class="checkbox">
                   <label><input type="checkbox">November</label>
                 </div>
                  <div class="checkbox">
...
<span  style="display:none;" class="edit">Edit</span></span>
			...
			<span class="status"><i class="fa fa-info-circle" aria-hidden="true"></i></span> Enter additional comments if any
				...
				<div class="col-md-offset-1 col-md-10">  
                      ...
                      <div class="form-group row" style="    margin-top: 10px;margin-bottom: 20px;">
                   <div class="col-sm-12" >
                  <label class="control-label"><h4>How did you hear about us?</h4>
                    </label>
                  </div>
                  <div class="col-sm-3">
                  <div class="checkbox">
