...
class SharefileComponent extends Component {
	...
	public function create_client($hostname, $client_api_id, $client_secret, $username, $password, $email, $firstname, $lastname, $client_id, $client_logged_id, $sharefile_folder_id){
	...
	public function access_control($hostname, $client_api_id, $client_secret, $new_username, $new_password, $folder_id, $sharefile_client_id){
		...
		$data['sendDefaultNotification']=FALSE;
